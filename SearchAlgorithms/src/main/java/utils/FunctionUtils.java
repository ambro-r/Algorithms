...
public class FunctionUtils {
  ...
  public static Point[][] buildPointMap(String equation, Range xRange, Range yRange, double stepSize) throws Exception {
    ...
    for(int row = 0; row < xResults; row++) {
      ...
      for(int col = 0; col < yResults; col++) {
        points[row][col] = new Point(x, y, function.function(x, y));
        y += stepSize;
      }
      x += stepSize;
    }
